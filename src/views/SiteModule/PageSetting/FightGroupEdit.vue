...
<template>
  <div class="imageEditWrap">
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>编辑拼团模块</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="v-wrap listWrap"  v-loading="mainLoading">
      <div>
        <h3 class="v-title">编辑拼团模块</h3>
      </div>
      ...
      <div class="detailTable">
        <ProductChooseTable :listData="listData" url="selector/goSelectGroupGoods.do"/>
    ...
    toSaveData () {
      this.$refs.formDataRef.validate(async valid => {
        ...
        let req = {
          ...
          falsePageModuleContentId: this.falsePageModuleContentId,
          pagesToken: this.pagesToken,
          moduleType: 4, // 0:首页  1:图片编辑 2:商品编辑 3:导航编辑 4:拼团编辑 5:秒杀编辑
