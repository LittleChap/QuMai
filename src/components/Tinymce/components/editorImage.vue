<template>
  <div class="upload-container">
    ...
    <el-dialog append-to-body :visible.sync="dialogVisible" width="820px">
      <el-upload class="editor-slide-upload" action="backend/mobileUpload/uploadImg.do" :data="fileData" name="file" :multiple="true" :file-list="fileList" :show-file-list="true"
